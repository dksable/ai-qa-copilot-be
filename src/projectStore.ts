...
function normalizeRepositoryGeneratedTestUpdate(update: RepositoryGeneratedTestUpdate): RepositoryGeneratedTestUpdate {
  ...
  return {
    ...
    repositoryMatchScore: update.repositoryMatchScore ?? update.confidenceScore ?? 0,
    locatorConfidence: update.locatorConfidence ?? update.confidenceScore ?? 0,
    assertionConfidence: update.assertionConfidence ?? update.confidenceScore ?? 0,
    businessCoverageScore: update.businessCoverageScore ?? update.confidenceScore ?? 0,
    maintainabilityScore: update.maintainabilityScore ?? update.confidenceScore ?? 0,
    estimatedStabilityScore: update.estimatedStabilityScore ?? update.confidenceScore ?? 0,
    repositoryContextSummary: update.repositoryContextSummary ?? {},
    qualityReport: update.qualityReport ?? {
      repositoryStyleMatch: update.repositoryMatchScore ?? update.confidenceScore ?? 0,
      businessCoverage: update.businessCoverageScore ?? update.confidenceScore ?? 0,
      locatorQuality: update.locatorConfidence ?? update.confidenceScore ?? 0,
      assertionQuality: update.assertionConfidence ?? update.confidenceScore ?? 0,
      maintainabilityScore: update.maintainabilityScore ?? update.confidenceScore ?? 0,
      estimatedExecutionStability: update.estimatedStabilityScore ?? update.confidenceScore ?? 0,
      potentialRisks: [],
      recommendations: [],
    },
    createdAt: timestamp,
...
function normalizeRepositoryValidationRun(run: RepositoryValidationRun): RepositoryValidationRun {
  ...
  return {
    ...
    validationStageTimings: run.validationStageTimings ?? [],
...
function normalizeRepositoryAnalysis(analysis: RepositoryAnalysis): RepositoryAnalysis {
  ...
  return {
    ...
    confidenceScore: analysis.confidenceScore ?? 0,
    playwrightVersion: analysis.playwrightVersion ?? "Unknown",
    packageManager: analysis.packageManager ?? analysis.buildTool ?? "Unknown",
    githubActionsCompatible: analysis.githubActionsCompatible ?? false,
    onboardingStatus: analysis.onboardingStatus ?? "Needs Review",
    readinessScore: analysis.readinessScore ?? analysis.confidenceScore ?? 0,
